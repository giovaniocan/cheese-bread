...
export function ModalCard({ isOpen, onRequestClose, product }: ModalCardProps) {
  return (
    <ReactModal
      ...
      className=" relative pt-10 pb-4 px-4 bg-white border-1 shadow-3xl rounded-lg  mx-4 w-full lg:w-1/3 lg:p-10 dark:bg-zinc-900 dark:border"
    >
      ...
      <div className="flex flex-col gap-8">
        <div className="flex flex-col items-center justify-between gap-4">
          <h2 className="font-semibold -mt-8 text-lg md:text-2xl">
            {product.name}
          </h2>
          <Image
            src={product.image}
          ...
          />
          <span className="font-light text-center text-sm md:text-base text-zinc-700">
        ...
        <div className="flex flex-col gap-4">
          ...
          <button className="w-full bg-green-bg-button text-black py-4 text-base md:text-lg rounded-full font-semibold uppercase">
